...
import { IResourceLinkFindAllOptions } from "./interface";

import { ResourceLink } from "../models";
import { getUserFieldDescriptions } from "../models/ResourceLink";
...
class ResourceLinkController {
  ...
  public async create(req: Request, res: Response): Promise<Response> {
    try {
      ...
      const create = await ResourceLink.create({ label, url });
  ...
  public async getAll(req: Request, res: Response): Promise<Response> {
    try {
      const options: IResourceLinkFindAllOptions = {};
      ...
      const findAll = await ResourceLink.findAll(options);
  ...
  public async getById(req: Request, res: Response): Promise<Response> {
    try {
      ...
      const findByPk = await ResourceLink.findByPk(uuid);
...
export default new ResourceLinkController();
